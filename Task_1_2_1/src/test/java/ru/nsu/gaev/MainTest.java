...
class MainTest {
    ...
    void testMain_Success(@TempDir Path tempDir) throws IOException {
        ...
        try {
            ...
            assertEquals("", errorStreamCaptor.toString().trim(), "Ожидалось, что ошибок не будет.");

            String actualOutput = outputStreamCaptor.toString();
            assertTrue(actualOutput.contains("List vs Matrix equals: true"), "Должно быть найдено сравнение equals.");
            assertTrue(actualOutput.contains("Topological Sort"), "Должен быть найден заголовок сортировки.");
