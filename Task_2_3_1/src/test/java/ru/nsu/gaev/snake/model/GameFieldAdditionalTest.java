...
class GameFieldAdditionalTest {
    ...
    void testPlayerSelfCollision() {
        ...
        player.setNextDirection(Direction.LEFT); field.update();
        player.setNextDirection(Direction.DOWN); field.update();
        player.setNextDirection(Direction.RIGHT); field.update();
        player.setNextDirection(Direction.UP); field.update();
