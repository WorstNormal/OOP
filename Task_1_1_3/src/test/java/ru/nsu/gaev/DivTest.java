...
class DivTest {
    ...
    void testEval() {
        ...
        final Expression expr = new Div(new Add(x, new Number(2)),
                new Add(new Number(3), y));
    ...
    void testSimplify() {
        ...
        assertEquals(2, ((Number) simplifiedExpr).getValue());
    }
    ...
    void testEquals() {
        Expression x = new Variable("x");
        Expression expr1 = new Div(x, new Number(2));
        Expression expr2 = new Div(x, new Number(2));
        Expression expr3 = new Div(x, new Number(3));
    ...
    void testSimplifyDivByOne() {
        Expression expr = new Div(new Number(5), new Number(1));
        Expression simplifiedExpr = expr.simplify();
        assertInstanceOf(Number.class, simplifiedExpr);
    ...
    void testSimplifyDivZeroNumerator() {
        Expression expr = new Div(new Number(0), new Number(3));
        Expression simplifiedExpr = expr.simplify();
        assertInstanceOf(Number.class, simplifiedExpr);
