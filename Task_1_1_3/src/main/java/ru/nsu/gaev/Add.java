...
public class Add extends Expression {
    ...
    /**
     * Вычисляет производную от данного выражения по заданной переменной.
     * Для сложения выполняется правило:
     * <pre>
     * (f + g)' = f' + g'
     * </pre>
     *
     * @param var имя переменной, по которой берётся производная
     * @return новое выражение {@code Add}, представляющее производную
     */
    @Override
     ...
     * Если оба операнда являются числами, возвращается одно числовое выражение {@code Number}.
     *
     ...
     * @return {@code true}, если оба объекта — экземпляры {@code Add} и имеют одинаковые операнды
     */
    @Override
