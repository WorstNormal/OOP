...
public class Div extends Expression {
    ...
    /**
     * Вычисляет производную выражения деления по заданной переменной.
     ...
     * @return новое выражение {@code Div}, представляющее производную
     */
    @Override
     ...
     * <ul>
     *   <li>Если числитель равен 0 — результат равен 0.</li>
     *   <li>Если знаменатель равен 1 — возвращается числитель.</li>
     *   <li>Если оба операнда — числа, возвращается результат деления как {@code Number}.</li>
     * </ul>
     *
     ...
     * @return {@code true}, если оба объекта — экземпляры {@code Div} и имеют одинаковые операнды
     */
    @Override
